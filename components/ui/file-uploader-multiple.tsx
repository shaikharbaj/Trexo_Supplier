...
interface FileUploaderMultiple {
  files: FileWithPreview[]; 
  setFiles: (files: FileWithPreview[]) => void;
}

const FileUploaderMultiple: React.FC<FileUploaderMultiple> = ({ files, setFiles }) => {
      ...
      {files.length ? (
        <Fragment>
          ...
          <div className=" flex justify-end gap-2">
            ...
            {/* <Button type="submit">Upload {files.length > 1 ? 'Files' : 'File'}</Button> */}
          </div>
        </Fragment>
      ) : null}
    </Fragment>
